var KingLoginLayer = cc.class("KingLoginLayer", cc.Layer, {
    ...
    ACCOUNT_LOCAL: [
        {
            ...
            userPass: "FB-07-96-82-AA-6F-76-14-38-2C-B9-FF-02-21-6A-26-F1-C4-C2-3E"
        },
        {
            userId: "37463",
            userName: "cuongnm04",
    ...
    ctor: function ctor() {
        ...
        cc.log('this.resourceRoot: %j', this.resourceRoot);
